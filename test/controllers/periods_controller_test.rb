...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post periods_url, params: { period: { description: @period.description, image: @period.image, song: @period.song } }
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { description: @period.description, image: @period.image, song: @period.song } }
